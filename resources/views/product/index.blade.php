                ...
                <div class="card">
                    <div class="card-header">
                        <div class="float-left">
                            <form class="m-0" action="{{ route('producto.index') }}" method="GET">
                                <div class="form-row align-items-center">
                                    <div class="col-auto">
                                        <label class="sr-only" for="search">search</label>
                                        <input type="text" class="form-control mb-2" name="search" id="search" placeholder="{{ __('Buscar Producto') }}"  value="{{ $search }}">
                                    </div>
                                    <div class="col-auto">
